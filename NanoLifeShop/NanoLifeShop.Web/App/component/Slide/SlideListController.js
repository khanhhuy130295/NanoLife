    ...
    function (app) {
        ...
        function SlideListController($scope, apiService, notificationService, $ngBootbox, $filter) {
            ...
            function GetlistData(page) {
                ...
                apiService.get("/api/slide/getall", config, function (response) {

                    if (response.data.TotalCount == 0) {
                        notificationService.DisplayWarning("Không có dữ liệu !");
                    }
                    $scope.DataSlide = response.data.Items;
            ...
            function SelecteAll() {
                if ($scope.isSelectedAll === false) {
                    angular.forEach($scope.DataSlide, function (item) {
                        item.check = true;
                    });
            ...
            $scope.$watch("DataSlide", function (n, o) {
            ...
            function DeleteItem(id) {
                ...
                $ngBootbox.confirm('Bạn muốn xóa danh mục này ?')
                    .then(function () {
                        ...
                        apiService.dele('/api/slide/delete', config, function (result) {
            ...
            function DeleMultiProCate() {
                ...
                $ngBootbox.confirm('Bạn muốn xóa những danh mục này ?')
                    .then(function () {
                        ...
                        apiService.dele('/api/slide/deleteMulti', config, function (response) {
