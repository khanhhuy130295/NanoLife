...
namespace NanoLifeShop.Web.App_Start
{
    public partial class Startup
    {
        public void ConfigurationAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(NanoLifeShopDBContext.Create);
            ...
            // Configure the sign in token OAuth
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<NanoLifeShopDBContext>());
